    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item> <i class="el-icon-grape"></i> 图像数据扩增系统 </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
...
export default {
    ...
    methods: {
        ...
        async onSubmit() {
            ...
            final_form['p1'] = this.form.p1;
            final_form['p2'] = this.form.p2;
            final_form['p3'] = this.form.p3;
        ...
        async onSubmit_DCGAN() {
            ...
            final_form['data_path'] = this.dl_form_DCGAN.data_path;
            final_form['save_path'] = this.dl_form_DCGAN.save_path;
            final_form['n_epoch'] = this.dl_form_DCGAN.n_epoch;
            final_form['img_size'] = this.dl_form_DCGAN.img_size;
            final_form['img_num'] = this.dl_form_DCGAN.img_num;
            final_form['use_model'] = this.dl_form_DCGAN.use_model;
        ...
        async onSubmit_CYCLEGAN() {
            ...
            var final_form = this.dl_form_CYCLEGAN;
            for (var i in final_form) {
                console.log(i, final_form[i]);
                if (final_form[i] === '') {
                    return this.$message.error('传入参数格式非法，请重新填写！');
            ...
            final_form['data_path1'] = this.dl_form_CYCLEGAN.data_path1;
            final_form['data_path2'] = this.dl_form_CYCLEGAN.data_path2;
            final_form['save_path'] = this.dl_form_CYCLEGAN.save_path;
            final_form['n_epoch'] = this.dl_form_CYCLEGAN.n_epoch;
            final_form['img_num'] = this.dl_form_CYCLEGAN.img_num;
            final_form['use_model'] = this.dl_form_CYCLEGAN.use_model;
