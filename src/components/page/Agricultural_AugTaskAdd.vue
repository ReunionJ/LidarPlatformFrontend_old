                            ...
                            <el-tab-pane label="图像处理" name="first">
                                <el-form ref="form" :model="form" label-width="140px" size="mini">
                                    ...
                                    <el-form-item v-if="this.form.method == 3" label="噪声像素百分比">
                                        <el-input v-model="params_form[3].proportion"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 4" label="噪声像素百分比">
                                        <el-input v-model="params_form[4].proportion"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 4" label="噪声像素颜色">
                                        <el-input v-model="params_form[4].noise_color" placeholder="选填"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 5" label="亮度">
                                        <el-input v-model="params_form[5].A"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 5" label="浓度">
                                        <el-input v-model="params_form[5].beta"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 8" label="X">
                                        <el-input v-model="params_form[8].X"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 8" label="Y">
                                        <el-input v-model="params_form[8].Y"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 9" label="横向比例">
                                        <el-input v-model="params_form[9].hx"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 9" label="纵向比例">
                                        <el-input v-model="params_form[9].wx"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 10" label="旋转角度">
                                        <el-input v-model="params_form[10].Angle"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 10" label="x">
                                        <el-input v-model="params_form[10].x" placeholder="选填"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 10" label="y">
                                        <el-input v-model="params_form[10].y" placeholder="选填"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 11" label="横向比例">
                                        <el-input v-model="params_form[11].hx"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 11" label="纵向比例">
                                        <el-input v-model="params_form[11].wx"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 12" label="变换像素百分比">
                                        <el-input v-model="params_form[12].P"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 18" label="阈值">
                                        <el-input v-model="params_form[18].N"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 19" label="模板半径">
                                        <el-input v-model="params_form[19].radius"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 20" label="模板半径">
                                        <el-input v-model="params_form[20].radius"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 20" label="灰度相似性方差">
                                        <el-input v-model="params_form[20].graysimilarity"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 20" label="坐标空间的标注方差">
                                        <el-input v-model="params_form[20].space"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 21" label="模板半径">
                                        <el-input v-model="params_form[21].radius"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 22" label="模板半径">
                                        <el-input v-model="params_form[22].radius"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 22" label="方差">
                                        <el-input v-model="params_form[22].sigema"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 23" label="模板半径">
                                        <el-input v-model="params_form[23].radius"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 24" label="池化窗口长">
                                        <el-input v-model="params_form[24].size_h"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 24" label="池化窗口宽">
                                        <el-input v-model="params_form[24].size_w"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 25" label="池化窗口长">
                                        <el-input v-model="params_form[25].size_h"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 25" label="池化窗口宽">
                                        <el-input v-model="params_form[25].size_w"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 26" label="池化窗口长">
                                        <el-input v-model="params_form[26].size_h"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 26" label="池化窗口宽">
                                        <el-input v-model="params_form[26].size_w"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 27" label="池化窗口长">
                                        <el-input v-model="params_form[27].size_h"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 27" label="池化窗口宽">
                                        <el-input v-model="params_form[27].size_w"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 28" label="RGB信息">
                                        <el-switch class="marginRight" v-model="params_form[28].R" active-text="R"> </el-switch>
                                        <el-switch class="marginRight" v-model="params_form[28].G" active-text="G"> </el-switch>
                                        <el-switch class="marginRight" v-model="params_form[28].B" active-text="B"> </el-switch>
                                    </el-form-item>
                                    ...
                                    <el-form-item v-if="this.form.method == 30" label="擦除面积百分比下限">
                                        <el-input v-model="params_form[30].sl"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 30" label="擦除面积百分比上限">
                                        <el-input v-model="params_form[30].sh"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 30" label="擦除区域横纵边长比">
                                        <el-input v-model="params_form[30].r1"></el-input>
                                    </el-form-item>

                                    <el-form-item v-if="this.form.method == 31" label="主图像权重">
                                        <el-input v-model="params_form[31].P"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 31" label="目标图像长">
                                        <el-input v-model="params_form[31].H" placeholder="选填"></el-input>
                                    </el-form-item>
                                    <el-form-item v-if="this.form.method == 31" label="目标图像宽">
                                        <el-input v-model="params_form[31].W" placeholder="选填"></el-input>
                                    </el-form-item>
                    ...
                    <el-col :span="10">
                        <div class="demo-image">
                            <div class="block" v-for="fit in fits" :key="fit">
                                ...
                                <el-image style="width: 400px; height: 400px" :src="url" :fit="fit"></el-image>
                            </div>
                        </div>
                    </el-col>
                </el-row>
...
export default {
    ...
    methods: {
        ...
        onSubmit() {
            ...
            this.$http.defaults.baseURL = 'http://129.211.89.155:8001/api/';
            console.log('axios.defaults.baseURL:', this.$http.defaults.baseURL);
        ...
        colorHandleChange(color_value) {
            ...
            this.params_form[29].point = color_value[color_value.length - 1];
            console.log('point:', this.params_form[29].point);
        },
