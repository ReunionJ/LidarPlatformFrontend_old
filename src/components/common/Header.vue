<template>
    <div class="header">
        ...
        <div class="header-left">
            ...
            <img src="../../assets/radar.png" alt="" class="lidarPic" />
            <div class="logo">智能系统软件测试数据生成平台</div>
        </div>
        <!-- 顶侧右部全屏-消息-用户信息区域 -->
            ...
            <div class="header-user-con">
                ...
                <el-dropdown class="user-name" trigger="click" @command="handleCommand">
                    ...
                    <el-dropdown-menu slot="dropdown">
                        ...
                        <el-dropdown-item divided command="logout"><i class="el-icon-close"></i>退出登录</el-dropdown-item>
                    </el-dropdown-menu>
                </el-dropdown>
            </div>
        </div>
